...
class RealModel:
    ...
    def load(self):
        ...
        # Salva em arquivo temporário e carrega com torch.load
        ...
        # Verificação e mapeamento de chaves
...
def main():
    ...
    try:
        ...
        result = {
            ...
            "observacao": "gerado_pelo_modelo" if "fallback" not in result else "fallback",
            "sucesso": True,
            "device": device
        }
